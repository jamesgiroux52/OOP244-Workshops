...
/*
 ============================================================================
 Description : Workshop 3 - at_home - Working with classes and validating a
 	 	 	   SIM number using integer modulus and division.
 ============================================================================
 */
...
int main() {
	...
	do {
		...
		cin.getline(familyName, sict::max_name_length);
		cout << "Please enter your given name: ";
		cin.getline(givenName, sict::max_name_length);
